              ...
              <div class="card-body">
                ...
                @foreach($comment as $comments)
                  <li>
                    ...
                    <small class="badge badge-danger"><i class="far fa-clock"></i>{{$current=$comments->created_at->diffForHumans()}}</small>
                  </li>  
                @endforeach           
                  </ul>
              </div>
