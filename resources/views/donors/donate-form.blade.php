                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                    <div>
                                       <select name="identity" id="identity" class="inputformdonor" required>
                                    ...
                                    <div class="col-sm-6">
                                    <div>
                                      <input id="validationCustomUsername" type="email" placeholder="Email" class="inputformdonor" name="email" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="form-group">
                               <div class="row">
                                    <div class="col-sm-6">
                                       <div>
                                            <input class="inputformdonor" id="validationCustom01" type="text" placeholder="Full Name" name="name" value="" required autocomplete="name" autofocus>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <option selected disabled value="">Make Choose</option>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                       <div >
                                          <input id="PhoneNumber" type="text" placeholder="Phone Number" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group mb-3">
                                                <select class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="font-size:1.2rem" >
                                                         <option value="BTC" class="dropdown-item" >Bitcoin</option>
                                                         <option value="Rwf" class="dropdown-item" >Rwf</option>
                                                         <option value="Dollars" class="dropdown-item" >Us dollars</option>
                                                         <option value="Euro" class="dropdown-item" >Euro</option>
                                                         <option value="Pound" class="dropdown-item" >Pound</option>
                                                    <input type="text" name="amount" class="form-control" required placeholder="others coin" aria-label="Text input with dropdown button" style="font-size:1.2rem">
                                                </select>
                                        </div>
                                        ...
                                        <div id="momo" class="tab-pane fade">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div >
                                                           <input id="PhoneNumber" type="text" placeholder="Amount" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="stripe" class="tab-pane fade">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div >
                                                           <input id="PhoneNumber" type="text" placeholder="Card Number" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div >
                                                           <input id="PhoneNumber" type="text" placeholder="CVV" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div >
                                                           <input id="PhoneNumber" type="text" placeholder="Month" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div >
                                                           <input id="PhoneNumber" type="text" placeholder="Year" name="phoneNumber" class="inputformdonor" value="" required autocomplete="name" autofocus>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
