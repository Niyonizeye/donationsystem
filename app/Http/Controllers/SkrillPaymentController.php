...
class SkrillPaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->skrilRequest->return_url = 'http://donation.muhahe.com//payment-completed';
        $this->skrilRequest->cancel_url = 'http://donation.muhahe.com//payment-completed/payment-cancelled';
        $this->skrilRequest->logo_url = 'http://donation.muhahe.com/image/logo.png';
    ...
    public function makePayment(Request $request)
    {
        ...
        $this->skrilRequest->transaction_id = 'mt_rand( 1000000000, 9999999999 )'; // generate transaction id
        ...
        $this->skrilRequest->customer_email = 'niyoeanpaul1996@gmail.com';
    ...
    public function doRefund()
    {
        ...
        // request
        $prepare_refund_request->transaction_id = 'mt_rand( 1000000000, 9999999999 )';
        ...
        $prepare_refund_request->customer_email = 'niyoeanpaul@gmail.com';
